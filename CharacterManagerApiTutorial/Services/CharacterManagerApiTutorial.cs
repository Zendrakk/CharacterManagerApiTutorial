...
{
    public class CharacterService(CharacterManagerDbContext context) : ICharacterService
    {
        ...
        public async Task<Result> UpdateCharacterAsync(int id, Character updatedCharacter, Guid userGuid)
        {
            ...
            // Step 4: Normalize and trim input strings once
            updatedCharacter.Name = updatedCharacter.Name.Trim().ToLower();

            // Step 5: Validate name length (max 15 chars).
            ...
            // Step 10: Validate faction-race-class combination.
